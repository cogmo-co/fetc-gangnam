      ...
      {!plain && (
        <>
          ...
          <div className={styles.bg}>
            <Image src="/images/location.jpg" alt={a("locationAlt")} fill sizes="100vw" />
          </div>
            ...
            <div className={styles.infoRow}>
              ...
              <div>
                ...
                <div className={styles.subInfo}>
                  <div className={styles.transitBadges}>
            ...
            <div className={styles.infoRow}>
              ...
              <div>
                <div className={styles.scheduleGrid}>
                  <span>{t("weekdays")}</span><span>07:00 - 22:00</span>
                  <span>{t("saturday")}</span><span>07:00 - 15:00</span>
                </div>
                <div>{t("closed")}</div>
              </div>
            </div>
