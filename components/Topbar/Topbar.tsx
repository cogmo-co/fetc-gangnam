  ...
  return (
    <header className={`${styles.topbar} ${alwaysSolid || solid ? styles.solid : ""}`}>
      ...
      <div className={styles.right}>
        ...
        <a href={`tel:${PHONE}`} className={styles.callIcon} aria-label={t("call")}>
        ...
        <BookingLink className={`${styles.btn} ${styles.callText}`}>{t("booking")}</BookingLink>
        <BookingLink className={styles.callIcon} aria-label={t("booking")}>
