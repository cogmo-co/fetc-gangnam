...
const FAQS = [
  ...
  },
  {
    ...
    a: "재활 프로그램은 부상 정도, 수술 여부, 회복 단계에 따라 회차가 달라지며, 짧게는 8회 내외부터 길게는 수개월의 장기 프로그램까지 다양하게 구성됩니다. 모든 재활은 ①정밀 평가 및 원인 분석 ②가동성 및 감각 회복 ③기능 통합 ④일상기능 및 퍼포먼스 복귀의 4단계 프로세스를 따르며, 각 단계의 완료 여부를 평가로 확인한 뒤 다음 단계로 진행합니다. 첫 상담 시 평가 결과를 바탕으로 개인에게 필요한 회차와 진행 일정을 구체적으로 안내해 드리며, 진행 중에도 회복 속도에 맞춰 프로그램이 유연하게 조정됩니다.",
  },
  {
    q: "강남점 위치와 주차가 가능한가요?",
    a: "강남점은 서울 강남구 도곡로7길 6 한은빌딩 4층에 위치하며, 신분당선·2호선 강남역 4번 출구에서 도보 약 15분, 바디프렌드 역삼타워 뒷편(뱅뱅사거리 도보 5분) 거리입니다. 주차 이용 가능합니다. 다만 주차 공간이 제한적일 수 있으므로 가능하시면 대중교통 이용을 권장드립니다.",
  },
  {
    q: "운영 시간이 어떻게 되나요?",
